        // Script para el modal de login (copiado de Home.html)
        ...
        function showStep(stepNumber) {
            ...
            document.querySelectorAll('.registro-sidebar-step').forEach(step => step.classList.remove('active'));
            document.querySelector(`.registro-sidebar-step[data-step="${stepNumber}"]`).classList.add('active');
        ...
        function validateStep(stepNumber) {
            let isValid = true;
            const currentStepFields = document.querySelectorAll(`#step${stepNumber} [required]`);
